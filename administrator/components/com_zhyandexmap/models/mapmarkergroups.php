...
/**
 * ZhYandexMarkerGroups Model
 */
class ZhYandexMapModelMapMarkerGroups extends JModelList
{
	...
	protected function getListQuery() 
	{
		...
		$query->select('h.id,h.title,h.published,h.publish_up,h.publish_down,h.catid,h.icontype,c.title as category');
