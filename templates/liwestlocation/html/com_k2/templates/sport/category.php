...
<div id="k2Container" class="itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemListCategoriesBlock">
		...
		<!-- Category block -->
		<div class="itemListCategory-about">
	...
	<div class="itemList">
		...
		<div id="itemListLinks">
			<h4><?php echo JText::_('Рекомендуем'); ?></h4>
			<div  slass="row-fluid">
			...
			<div class="span2"<?php echo (count($this->links)==1) ? '' : ' style=""'; ?>>
				<?php
