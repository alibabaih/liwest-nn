...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemHeader">
		...
		<!-- Date created -->
		<div class="catItemDateCreated-about">
	  ...
	  <!-- Item title -->
	  <div class="catItemTitle-about">
	  	<span class="itemTitle-about-p">
  ...
  <?php echo $this->item->event->K2AfterDisplayTitle; ?>
	...
	<?php if(
  	...
  	<div class="row-fluid itemTagsCommensBlock">
  		  	<?php if($this->item->params->get('itemTags') && count($this->item->tags)): ?>
		  		<!-- Item tags -->
		  		<div class="span6">
		  		<div class="tagsBlock">	
				  	<span><?php echo JText::_('<i class="icon-tags icon-white"></i>'); ?></span>
				  	<ul class="itemTags">
						...
						<li>
							...
							<?php else: ?>
								...
								<a class="itemCommentsLink k2Anchor" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
									<?php echo ($this->item->numOfComments>1) ? JText::_('K2_COMMENTS') : JText::_('<i class="icon-comment icon-white"></i>'); ?>
								</a>
								<?php else: ?>
								
								<a class="itemCommentsLink k2Anchor" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
									<?php echo JText::_('<i class="icon-comment icon-white"></i>'); ?>
								</a>
								<?php endif; ?>
							<?php endif; ?>
						</li>
  ...
  <div class="itemBody">
	  ...
	  <div class="itemImageBlock">
		  <span class="itemImage">
		  	<a class="thumbnail" rel="{handler: 'image'}" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
...
<div class="row-fluid">
		  ...
		  <?php if($this->item->params->get('itemCategory') || $this->item->params->get('itemTags') || $this->item->params->get('itemAttachments')): ?>
		  	<div class="itemLinks">
				...
				<div class="itemCategory">
					<span><?php echo JText::_('<i class="icon-folder-close icon-white"></i>'); ?></span>
  ...
  <!-- Related items by tag -->
	<div class="itemRelated">
		<h4><?php echo JText::_("Интересные статьи"); ?></h4>
		<div class="row-fluid">
			<?php foreach($this->relatedItems as $key=>$item): ?>
			<div class="<?php echo ($key%2) ? "span3" : "span3"; ?>">
				...
				<div style="titleItemRelated">
					<?php if($this->item->params->get('itemRelatedTitle', 1)): ?>
					<p class="hyphenate text"><a class="itemRelTitle" href="<?php echo $item->link ?>"><?php echo $item->title; ?></a></p>
					<?php endif; ?>
				</div>
  ...
  <div class="itemNavigation">
  	<p style="text-align: center;">
	  	<span class="itemNavigationTitle"><?php echo JText::_('Перейти к предыдущей или следующей статье'); ?></span>
	 </p>
