        ...
        <div class="post-image">
            ...
            <div class="media-hover">
                <div class="media-icons">
                    <a href="<?php echo $this->item->image; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" data-group="media-jackbox" class="jackbox media-icon"><i class="icons icon-zoom-in"></i></a>
                    <a href="<?php echo $this->item->link; ?>" class="media-icon"><i class="icons icon-link"></i></a>
                </div>
            </div>
        </div>
    <?php endif; ?>
    ...
    <div class="post-content">
        <div class="post-side-meta">
            ...
            <div class="post-comments">
                <a href="<?php echo $this->item->link; ?>#itemCommentsAnchor"><i class="icons icon-chat-empty"></i></a>
            </div>
        </div>

        <div class="post-header">
            <h2><a href="blog-single-sidebar.html">
