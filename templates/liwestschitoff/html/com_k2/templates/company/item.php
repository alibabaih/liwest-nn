                    ...
                    <tbody><tr>
                        <td class="share-media">
                            <ul class="social-share">
                                ...
                                <li class="facebook"><a href="https://www.facebook.com/liwest.nn" class="tooltip-ontop" title="" data-original-title="Facebook" target="_blank"><i class="icons icon-facebook"></i></a></li>
                                <li class="twitter"><a href="https://twitter.com/liwest_nn" class="tooltip-ontop" title="" data-original-title="Twitter" target="_blank"><i class="icons icon-twitter"></i></a></li>
                                <li class="google"><a href="https://plus.google.com/u/0/b/110807986209679994948/+Liwest-nnRu/posts" class="tooltip-ontop" title="" data-original-title="Google Plus" target="_blank"><i class="icons icon-gplus"></i></a></li>
                                <li class="pinterest"><a href="#" class="tooltip-ontop" title="" data-original-title="Pinterest" target="_blank"><i class="icons icon-pinterest-3"></i></a></li>
                                <li class="email"><a href="mailto:liwest@liwest-nn.ru" class="tooltip-ontop" title="" data-original-title="Email"><i class="icons icon-mail"></i></a></li>
                            </ul>
                        </td>
                        <!-- Item tags -->
                        <?php if($this->item->params->get('itemTags') && count($this->item->tags)): ?>
                        <td class="tags"><?php echo JText::_('K2_TAGGED_UNDER'); ?>
