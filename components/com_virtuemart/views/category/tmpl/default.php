	...
	if (!empty($this->category->haschildren)) {
		...
		if (!empty($this->category->children)) {
			...
			<?php
				...
				// Show Category
				?>
				<div class="col-lg-4 col-md-4 col-sm-4<?php //Выводится подкатегория категории
												 ?>">
			...
			<div class="product-list">
				<div class="col-lg-4 col-md-4 col-sm-4">
                    <div class="img-product-box">
                        <a title="<?php echo $product->product_name ?>" rel="vm-additional-images" href="<?php echo $product->link; ?>">
                            <?php
                                echo $product->images[0]->displayMediaThumb('class="img-rounded"', false);
				...
				<div class="col-lg-8 col-md-8 col-sm-8">
					...
					if (!empty($product->product_s_desc)) {
						?>
						<p class="product_s_desc hyphenate text">
					...
					<p>
						...
						echo JHTML::link ($product->link, JText::_ ('COM_VIRTUEMART_PRODUCT_DETAILS'), array('title' => $product->product_name, 'class' => 'button'));
						?>
					</p>

				</div>
				<div class="clear"></div>
			</div> <div class="bottom-product-list"></div>
			<!-- end of spacer -->
		</div> <!-- end of product -->
		<?php
...
<div class="pagination pagination-centered"><?php echo $this->vmPagination->getPagesLinks (); ?></div>
