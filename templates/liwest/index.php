...
<?php
$subscribe="row-fluid";
if($this->countModules('subscribe') == 0)
    : $subscribe="row-fluid";
endif;
?>
...
<div class="<?php echo $background;?>">
    ...
    <div class="row-fluid">
        ...
        <?php if ($this->countModules('compnent-right')): ?>
            <div class="<?php echo $CompnentRight?>">
                <jdoc:include type="modules" name="compnent-right" style="xhtml" />
            </div> <div class="offset1"></div>
        <?php endif;?>
    </div>
</div>
...
<?php if ($this->countModules('subscribe')): ?>
    <div class="<?php echo $subscribe;?>">
        <div class="span12  subscribe-mod">
            <jdoc:include type="modules" name="subscribe" style="cleans" />
        </div>
        <div class="offset1">
        </div>
    </div>
