...
<div class="width-60 fltlft">
	<fieldset class="adminform">
		<legend><?php echo JText::_( 'COM_ZHYANDEXMAP_MAPPATH_DETAIL' ); ?></legend>
...
<?php echo JHtml::_('sliders.start', 'mappath-slider'); ?>
...
<?php echo JHtml::_('sliders.start', 'mappath-slider2'); ?>

	<?php echo JHtml::_('sliders.panel', JText::_('COM_ZHYANDEXMAP_MAPPATH_PATHADVANCED'), 'path-advanced');?>
	<fieldset class="adminform">
		<ul class="adminformlist">
