...
/*
 * =============================================================
 * RAXO All-mode K2 J2.5 - Tool
 * -------------------------------------------------------------
 * @package		RAXO All-mode K2
 * @subpackage	TimThumb RAXO Edition
...
if(! defined('FILE_CACHE_DIRECTORY'))		define ('FILE_CACHE_DIRECTORY', '../../../images/raxo_thumbs');	// Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
if(! defined('MAX_FILE_SIZE'))				define ('MAX_FILE_SIZE', 5242880);			// 10 Megs is 10485760. This is the max internal or external file size that we'll process.
...
if(! defined('DEFAULT_Q'))					define ('DEFAULT_Q', 89);				// Default quality value
...
class timthumb {
	...
	protected function processImageAndWriteToCache($localImage){
		...
		} else if ($new_width && $new_height && !$zoom_crop) {
			$ratio = $width / $height;
	...
	protected function serveWebshot(){
		...
		//Very important we don't allow injection of shell commands here. URL is between quotes and we are only allowing through chars allowed by a the RFC KT02
