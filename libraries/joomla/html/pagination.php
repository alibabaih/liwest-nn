...
class JPagination extends JObject
{
	...
	public function getPagesLinks()
	{
		...
		foreach ($data->pages as $i => $page)
		{
			...
			else
			{
                ...
                //////////////////////
                ///////////////////////
                //change on inactive pagination_item_active($page) : $this->_item_active($page);
				$list['pages'][$i]['data'] = ($itemOverride) ? pagination_item_active($page) : $this->_item_active($page);
			}
		}
	...
	protected function _list_render($list)
	{
		...
		$html .=  $list['start']['data'] ;//в начало
		$html .=  $list['previous']['data'] ;//назад
		foreach ($list['pages'] as $page)
		{
			$html .=  $page['data'] ;
		}
		$html .=  $list['next']['data'] ;//вперёд
		$html .=  $list['end']['data'] ;//в конец
...
//    }
	...
	protected function _item_active(&$item)
	{
		...
		{
			return "<a title=\"" . $item->text . "\" href=\"" . $item->link . "\" class=\"button\">" . $item->text . "</a>";
		}
	}
