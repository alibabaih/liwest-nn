...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <!-- Item navigation -->
  <span class="itemNavigationTitle"><?php echo JText::_('Последующие статьи в этом каталоге'); ?></span>
  <ul class="pager">
  	

		<?php if(isset($this->item->previousLink)): ?>
		<li class="previous"><a class="itemPrevious" href="<?php echo $this->item->previousLink; ?>">
			&laquo; <?php echo $this->item->previousTitle; ?>
		</a></li>
		<?php endif; ?>

		<?php if(isset($this->item->nextLink)): ?>
		<li class="next"><a class="itemNext" href="<?php echo $this->item->nextLink; ?>">
 ...
 <?php if($this->item->params->get('itemComments') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2')) && empty($this->item->event->K2CommentsBlock)): ?>
  ...
  <?php endif; ?>
	...
	<div class="clr"></div>
</div><div class="bottom-white-bg-k2"></div>
<!-- End K2 Item Layout -->
