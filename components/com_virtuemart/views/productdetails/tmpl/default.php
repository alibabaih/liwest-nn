...
<div class="shop-single">
    ...
    <div class="shop-product-content">
        ...
        <!--Price-->
        <span class="price animate-onscroll"><del></del>
	...
	<?php echo JText::_('COM_VIRTUEMART_RATING') . ' ' . round($this->rating->rating) . '/' . $maxrating; ?><br/>
        ...
        <p class="animate-onscroll hyphenate text">
        ...
        <!--<a href="#" class="disabled add-to-cart-button button donate animate-onscroll disabled">В корзину</a>-->
...
</div><div class="bottom-product-details"></div>
