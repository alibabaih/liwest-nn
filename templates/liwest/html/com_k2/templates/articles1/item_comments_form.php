...
<p><span class="itemNavigationTitle"><?php echo JText::_('K2_LEAVE_A_COMMENT') ?></span></p>
...
<form action="<?php echo JRoute::_('index.php'); ?>" method="post" id="comment-form" class="form-validate">
	<div class="span6">
		<label class="formComment" for="commentText"><?php echo JText::_('Сообщение'); ?> *</label>
	...
	<div class="span6">
		<label class="formName" for="userName"><?php echo JText::_('Имя'); ?> *</label>
		...
		<label class="formEmail" for="commentEmail"><?php echo JText::_('Почта'); ?> *</label>
		...
		<label class="formUrl" for="commentURL"><?php echo JText::_('Веб сайт'); ?></label>
		...
		<input type="submit" class="button" id="submitCommentButton" value="<?php echo JText::_('Отправить'); ?>" />
	</div>
