...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2UserBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <?php endif; ?>
	...
	<div class="k2UserBlockDetails">
	  ...
	  <span class="ubName"><?php echo $user->name; ?></span>
		<span class="ubCommentsCount"><?php echo JText::_('У вас'); ?> <b><?php echo $user->numOfComments; ?></b> <?php if($user->numOfComments==1) echo JText::_('опубликованный комментарий'); else echo JText::_('опубликованных комментариев'); ?></span>
	  <div class="clr"></div>
	</div>
  ...
  <ul class="k2UserBlockActions">
		...
		<li>
			<a class="modal" rel="{handler:'iframe',size:{x:990,y:550}}" href="<?php echo $user->profile->addLink; ?>"><?php echo JText::_('Добавить материал'); ?></a>
		</li>
		<?php endif; ?>
		<li>
		...
		<li>
			<a class="modal" rel="{handler:'iframe',size:{x:990,y:550}}" href="<?php echo JRoute::_('index.php?option=com_k2&view=comments&tmpl=component'); ?>"><?php echo JText::_('Смотреть неопубликованные комментарии к материалам'); ?></a>
		</li>
	</ul>
